...
> release notes for the github publication of polar `v1.7`, online build.
> written in lowercase, in english, following the same format as `v1.6.2`.
>
> this is the standard build: polar with supabase cloud sync. the 100% offline
> build is documented in `release-v1.7.md`, and the combined release in
> `release-v1.7-complete.md`.
